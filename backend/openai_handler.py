        ...
        while iteration < max_iterations:
            ...
            try:
                ...
                if ("context_length_exceeded" in error_str
                    ...
                    if empty_retries < 3:
                        continue
                    return (
                        "Наш диалог получился длинным. Оставьте имя и телефон — "
                        "менеджер перезвонит и поможет завершить подбор. "
            ...
            if not _is_error_response and self._context_warning_stage < 2:
                ...
                if _hist_len >= _WARNING_HARD and self._context_warning_stage < 2:
                    ...
                    final_text += (
                        "\n\n---\n"
                        "Мы обсудили много вариантов. Чтобы не терять время, "
                        "давайте я передам ваш контакт менеджеру — он перезвонит "
                        "и поможет завершить подбор. Оставьте имя и телефон, пожалуйста."
                    )
